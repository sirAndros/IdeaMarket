<?php
/**
 * @version		$Id: tag.php 1632 2012-09-25 09:52:39Z lefteris.kavadas $
 * @package		K2
...
class K2ElementTag extends K2Element
{
...
class JFormFieldTag extends K2ElementTag
{
    var $type = 'tag';
}

class JElementTag extends K2ElementTag
{
    var $_name = 'tag';
}
