<?php
/**
 * @version		$Id: mod_k2_quickicons.php 1779 2012-11-22 17:21:38Z lefteris.kavadas $
 * @package		K2
...
if ($modCSSStyling)
	$document->addStyleSheet(JURI::base(true).'/modules/'.$mod_name.'/tmpl/css/style.css?v=2.6.2');
