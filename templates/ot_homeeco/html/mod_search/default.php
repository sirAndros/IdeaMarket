...
?>
<form class="default-search" action="<?php echo JRoute::_('index.php');?>" method="post">
	<div class="search<?php //echo $moduleclass_sfx ?>">
		<?php
			...
			if ($button) :
				if ($imagebutton) :
					$button = '<input type="image" value="'.$button_text.'" class="button" src="templates/ot_homeeco/images/search-btn.png" onclick="this.form.searchword.focus();"/>';
				else :
