...
<div class="browse-view">
	<div class="orderby-displaynumber">
		...
		<div class="width30 floatright display-number">
			<?php echo $this->vmPagination->getLimitBox(); ?><?php echo $this->vmPagination->getResultsCounter();?></div>
		<?php /* <div class="vm-pagination floatright">
	...
	<?php /*<h1><?php echo $this->category->category_name; ?></h1> */?>
	...
	foreach ( $this->products as $product ) {
		...
		// this is an indicator wether a row needs to be opened or not
		if ($iBrowseCol == 1) { ?>
		<div class="row <?php //if($this->products[0]) echo 'first'; ?> ot-custom-vmproduct">
		...
		if ($iBrowseProduct == $BrowseProducts_per_row or $iBrowseProduct % $BrowseProducts_per_row == 0) {
			...
			// Show Products ?>
			<div class="product floatleft<?php echo $Browsecellwidth . $show_vertical_separator ?> <?php if($iBrowseCol == $BrowseProducts_per_row) echo 'product-last'; ?>">
				<div class="spacer">
						...
						<div class="ot-custom-product-i">
							<div class="product-image">
								<div class="product-image-i">
									...
									<?php echo JHTML::link($product->link, $product->images[0]->displayMediaThumb("",false));?>
								</div>
								...
								<div class="product-addtocart">
									<?php if ($this->show_prices == '1') {?>
										<div class="product-price" id="productPrice<?php echo $product->virtuemart_product_id ?>">
											<?php if (empty($product->prices['salesPrice']) and VmConfig::get ('askprice', 1) and  !$product->images[0]->file_is_downloadable) {
											...
											// if (round($product->prices['basePriceWithTax'],VmConfig::get('salesPriceRounding')) != round($product->prices['salesPrice'],VmConfig::get('salesPriceRounding'))) {
									...
									<?php } ?>
									<?php /*<div class="product-addtocart-area">
	...
	?>
	<!-- /div removed valerie -->
		<?php /* <div class="vm-pagination"><?php echo $this->vmPagination->getPagesLinks(); ?><span style="float:right"><?php echo $this->vmPagination->getPagesCounter(); ?></span></div> */?>
		<?php if($this->vmPagination->getPagesCounter() != null) : ?>
		<div id="bottom-pagination"><p class="pageslinks"><?php echo $this->vmPagination->getPagesLinks(); ?></p></div>
		<?php endif; ?>
	<!-- /div removed valerie -->
