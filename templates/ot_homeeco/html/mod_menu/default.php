...
foreach ($list as $i => &$item) :
	...
	if ($item->deeper) {
		//echo '<div class="menu_round '.$item->anchor_css.'"><div class="menu_top"></div><div class="menu_mid"><ul class="level'.$item->level.' '.$item->anchor_css.'">';
		echo '<div class="menu_round"><div class="menu_top"></div><div class="menu_mid"><ul class="level'.$item->level.' '.$item->anchor_css.'">';
	}
