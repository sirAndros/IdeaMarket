					...
					<div class="catItemLinks">
						<?php if($this->item->params->get('catItemTags') && count($this->item->tags)): ?>
							<div class="catItemTagsBlock">
								<span><?php echo JText::_('TPL_OT_K2_TAGS'); ?></span>
			...
			<div class="catItemAdditionalInfo-i">
				...
				<?php if($this->item->params->get('itemDateCreated')): ?>
					<span class="itemDateCreated">
						<?php echo JText::_('TPL_OT_K2_DATETIME'); ?> <?php echo JHTML::_('date', $this->item->created , 'd'); ?> <?php echo JHTML::_('date', $this->item->created , 'M'); ?> <?php echo JHTML::_('date', $this->item->created , 'Y'); ?>
					</span>
				<?php endif; ?>
				<?php if($this->item->params->get('catItemCategory')): ?>
					<span class="catItemCategory"><?php echo JText::_('K2_PUBLISHED_IN'); ?>
						<a href="<?php echo $this->item->category->link; ?>"><?php echo $this->item->category->name; ?></a>
					</span>
				<?php endif; ?>
				...
				<?php if($this->item->params->get('catItemCommentsAnchor')): ?>
					<a href="<?php echo $this->item->link; ?>#itemCommentsAnchor" class="catItemComments k2Anchor">
