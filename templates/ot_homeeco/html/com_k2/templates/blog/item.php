...
<div id="k2Container" class="itemView<?php echo ($this->item->featured) ? ' itemIsFeatured' : ''; ?><?php if($this->item->params->get('pageclass_sfx')) echo ' '.$this->item->params->get('pageclass_sfx'); ?> ot-blog">
			...
			<div class="itemToolbar">
				<ul>
						...
						<li>
								...
								<?php else:?>
								<a class="itemComment k2Anchor" href="<?php echo $this->item->link; ?>#itemCommentsAnchor">
								<?php echo $this->item->numOfComments; ?> <?php echo JText::_('TPL_OT_K2_COMMENTS'); ?>
								</a>
								<?php endif; ?>
						</li>
						<?php endif; ?>
...
//$mlp='';
