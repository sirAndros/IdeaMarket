<?php
/**
 * @version		$Id: item.php 1767 2012-11-22 14:55:46Z lefteris.kavadas $
 * @package		K2
...
class K2ModelItem extends K2Model
{
	...
	function getItemExtraFields($itemExtraFields, &$item = null)
	{
		...
		{
			$this->buildAliasBasedExtraFields($K2ItemExtraFieldsInstances[$itemExtraFields], $item);
