...
class VirtueMartControllerCategories extends JController {
	...
	public function display($cachable = false, $urlparams = false) {
		...
		if(Permissions::getInstance()->check('admin')){
			vmWarn('This is using still the obsolete view categories! Change it to the new category view with categories layout, for more information please read here http://forum.virtuemart.net/index.php?topic=120433.0');
		}
